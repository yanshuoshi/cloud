package com.yss.baseservice.infrastructure.filter;
...
//            UserEntity user = JSON.parseObject(principal, UserEntity.class);
            ...
            if(CollectionUtils.isNotEmpty(tempJsonArray)){
                authorityList = AuthorityUtils.createAuthorityList(tempJsonArray.toArray(new String[0]));
            }
